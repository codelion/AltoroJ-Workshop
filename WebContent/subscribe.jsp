		...
		<div class="fl" style="width: 99%;">
			...
			<form action="doSubscribe" method="post" name="subscribe" id="subscribe" onsubmit="return confirmEmail(txtEmail.value);">
			  <table>
			    <tr>
			      <td colspan="2">
			        <div style="font-weight: bold; font-size: 12px; color: red;" id="message"><%= StringEscapeUtils.escapeHtml4((String)(request.getAttribute("message_subscribe")!=null?request.getAttribute("message_subscribe"):"")) %></div>
			      </td>
			    </tr>
			    <tr>
			      <td>
